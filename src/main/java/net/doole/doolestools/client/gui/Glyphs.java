...
public final class Glyphs {
    ...
    public interface Drawer { void draw(GuiGraphics g, int x, int y, int color); }

    /** Three rows of "list" lines with leading dots. */
    public static void list(GuiGraphics g, int x, int y, int c) {
        for (int i = 0; i < 3; i++) {
            int ry = y + i * 3;
    ...
    public static void graph(GuiGraphics g, int x, int y, int c) {
    ...
    public static void chart(GuiGraphics g, int x, int y, int c) {
    ...
    public static void gear(GuiGraphics g, int x, int y, int c) {
    ...
    public static void radar(GuiGraphics g, int x, int y, int c) {
    ...
    public static void refresh(GuiGraphics g, int x, int y, int c) {
    ...
    public static void plus(GuiGraphics g, int x, int y, int c) {
        g.fill(x + 3, y, x + 6, y + 9, c);
        g.fill(x, y + 3, x + 9, y + 6, c);
    }

    public static void minus(GuiGraphics g, int x, int y, int c) {
        g.fill(x, y + 4, x + 9, y + 6, c);
    }

    public static void trash(GuiGraphics g, int x, int y, int c) {
    ...
    /** Link / chain. */
    public static void link(GuiGraphics g, int x, int y, int c) {
        DUTheme.outline(g, x, y + 2, 5, 5, c);
        DUTheme.outline(g, x + 4, y + 2, 5, 5, c);
    }

    /** Auto-arrange: a small left-to-right tree. */
    public static void arrange(GuiGraphics g, int x, int y, int c) {
    ...
    public static void frame(GuiGraphics g, int x, int y, int c) {
        DUTheme.outline(g, x, y, 9, 9, c);
        g.fill(x, y, x + 9, y + 2, c);
    }

    /** Fit-to-view corner brackets. */
    public static void fit(GuiGraphics g, int x, int y, int c) {
    ...
    public static void warning(GuiGraphics g, int x, int y, int c) {
        GuiSprites.draw(g, GuiSprites.WARNING, x - 2, y - 2, 13);
    }

    private static void dot(GuiGraphics g, int x, int y, int c) {
